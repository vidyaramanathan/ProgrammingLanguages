...
abstract class TweetSet {
   ...
   */
   ...
   def compareTweets(thatTweet : Tweet) : Tweet
  /**
...
class Empty extends TweetSet {
  ...
  def compareTweets(thatTweet : Tweet) : Tweet = thatTweet
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def compareTweets(thatTweet : Tweet) : Tweet = {
    ...
    if(elem.retweets > thatTweet.retweets) elem else thatTweet
  }
  
  def mostRetweeted: Tweet = right.compareTweets(left.compareTweets(elem))
